...
class RestaurantLocationClass extends Component {
    ...
    render() {
			return (
					<div>
						<div class="col-sm-3 pl-5 text-black">
								...
								<div class="col-sm-9 p-5">
										...
										<div>
												<div class="w-50">
														...
														<input type="text" id="restaurantName" name="restaurantName" class="form-control" placeholder="e.g. Enter Restaurant Name" onChange={this.nameChangeHandler} value={this.state.name} required />
												</div>
												<div class="w-50">
														<label for="restaurantCuisine">Cuisine *</label>
														<input type="text" id="restaurantCuisine" name="restaurantCuisine" class="form-control" onChange={this.cusineChangeHandler} value={this.state.cuisine} required />
												</div>
										</div>
